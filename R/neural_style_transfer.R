# from https://tensorflow.rstudio.com/keras/articles/examples/neural_style_transfer.html
...
# Images
base_image_path <- "images/me2.jpg"
style_reference_image_path <- "images/vg_portrait.jpg"
iterations <- 10
